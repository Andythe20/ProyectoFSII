...
(function() {
    ...
    form.addEventListener('submit', function(e){
        ...
        if(ok){
            alerta.innerHTML = '<div class="alert alert-success" role="alert">Formulario enviado correctamente.</div>';
        }else{
            alerta.innerHTML = '<div class="alert alert-danger" role="alert">Por favor, verifique los datos ingresados.</div>';
